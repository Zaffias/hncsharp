...
public class DummyITCompany{
    public static ITCompany GenerateITCompany(){
        ...
        ProjectTeam team1 = new ProjectTeam{ProjectName = "Web Development", HalfPayed = true};
        ProjectTeam team2 = new ProjectTeam{ProjectName = "Mobile Development", HalfPayed = false};
        ...
        team1.AddProgrammer(programmer2);
        ...
        team2.AddProgrammer(programmer3);
