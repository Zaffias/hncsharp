...
public class DummyITCompany{
    public static ITCompany GenerateITCompany(){
        ...
        ProgrammerInCharge manager = new ProgrammerInCharge { FirstName = "John", LastName = "Doe", Activity = "Project management", StartDate = new DateTime(2022, 2, 22), Payment = 1000.0f };
        team.ProgrammersInCharge.Add(manager);
        Employee programmer1 = new Employee { FirstName = "Alice", LastName = "Smith", Activity = "Web development", StartDate = new DateTime(2022, 2, 22), Payment = 500.0f };
        Employee programmer2 = new Employee { FirstName = "Bob", LastName = "Johnson", Activity = "Mobile development", StartDate = new DateTime(2022, 2, 22), Payment = 600.0f };
